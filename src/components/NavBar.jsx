...
const NavBar = () => {
  ...
  return (
    <nav className=" text-[var(--main-fo-col)] relative flex justify-evenly max-w-full" id="navbar">
      <div className="flex ">
      ...
      <Link to="/" className="lg:flex -mr-24 items-center hidden">
        ...
        <ul
          className={`text-blue-800 font-semibold list-none justify-evenly text-center max-w-full ${
            menu ? 'flex justify-center flex-col-reverse text-right items-center absolute right-0 bg-[--main-bg-cl] mt-20 w-1/4 border-solid border-blue-500' : 'hidden'
        ...
        <div className=' p-5 text-left font-bold uppercase lg:static lg:transform-none lg:text-right lg:flex lg:items-center lg:justify-end lg:p-5 lg:ml-30 absolute left-0'>
