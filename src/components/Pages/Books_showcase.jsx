...
const Books_showcase = () => {
  ...
  return (
    <div className="container relative  flex flex-col mx-auto px-4 mb-40 max-w-full md:max-w-3xl lg:max-w-6xl">
      <div className=" grid grid-cols-2 md:mt-8 lg:mt-10">
        <div className='font-bold relative flex flex-col items-center justify-center text-2xl font-bold'>
  <h2 className=' text-[var(--main-fo-cl)]'>All Books</h2>
  <span className="absolute bottom-0 left-0 right-0 mx-auto border-b-2 border-[var(--main-fo-cl)] w-10" ></span>
</div>
  <button
            className="bg-blue-500 text-white font-bold px-4 py-2 rounded">
            <Link to='/BookList'>Browse All Books</Link>
          </button>
          </div>
